...
Al aplicar la transformación correspondiendo a la variable respuesta, se puede observar en la @fig-serie6 la evolución temporal del logaritmo natural de los pasajeros y la distribución anual del logaritmo de los pasajeros, en los cuales el rango de la variable es mucho menor y esto hace que la variable sea más estable en varianza. Analizando la variable en los años de interes, podemos observar que hasta el año 2019, la variable parece ser estable tanto en media como en varianza, pero posteriormente en los años siguientes, parece estabilizarse en varianza pero en media no, lo cual puede dar un indicio de diferenciar los datos a partir del año 2020. 
...
ajuste5 <- ensemble_sol5(list(ajuste1, ajuste2, ajuste3, ajuste4))
```
...
g6_graf_pronosticos(ajuste1 |> filter(.model == "arima"), 2020, 90, color = "#263D92")
g6_graf_pronosticos(ajuste1 |> filter(.model == "arima"), 2021, 90, color = "#263D92")
g6_graf_pronosticos(ajuste1 |> filter(.model == "arima"), 2022, 90, color = "#263D92")
g6_graf_pronosticos(ajuste1 |> filter(.model == "arima"), 2023, 90, color = "#263D92")
g6_graf_pronosticos(ajuste1 |> filter(.model == "arima"), 2024, 90, color = "#263D92")
```
...
g6_graf_pronosticos(ajuste1 |> filter(.model == "ets"), 2020, 90, color = "#E47E11")
g6_graf_pronosticos(ajuste1 |> filter(.model == "ets"), 2021, 90, color = "#E47E11")
g6_graf_pronosticos(ajuste1 |> filter(.model == "ets"), 2022, 90, color = "#E47E11")
g6_graf_pronosticos(ajuste1 |> filter(.model == "ets"), 2023, 90, color = "#E47E11")
g6_graf_pronosticos(ajuste1 |> filter(.model == "ets"), 2024, 90, color = "#E47E11")
```
\newpage
...
g6_graf_pronosticos(ajuste2, 2020, 90, color = "#AE00B8")
g6_graf_pronosticos(ajuste2, 2021, 90, color = "#AE00B8")
g6_graf_pronosticos(ajuste2, 2022, 90, color = "#AE00B8")
g6_graf_pronosticos(ajuste2, 2023, 90, color = "#AE00B8")
g6_graf_pronosticos(ajuste2, 2024, 90, color = "#AE00B8")
```
\newpage
...
#| layout-nrow: 3
#| layout-ncol: 2
#| fig-cap: "Pronósticos utilizando STM"
#| fig-subcap: 
#|    - "Pronóstico año 2020"
#|    - "Pronóstico año 2021"
#|    - "Pronóstico año 2022"
...
g6_graf_pronosticos(ajuste3, 2020, 90, color = "#E51010")
g6_graf_pronosticos(ajuste3, 2021, 90, color = "#E51010")
g6_graf_pronosticos(ajuste3, 2022, 90, color = "#E51010")
g6_graf_pronosticos(ajuste3, 2023, 90, color = "#E51010")
g6_graf_pronosticos(ajuste3, 2024, 90, color = "#E51010")
```
...
#| layout-nrow: 3
#| layout-ncol: 2
#| fig-cap: "Pronósticos utilizando WMHB"
#| fig-subcap: 
#|    - "Pronóstico año 2020"
#|    - "Pronóstico año 2021"
#|    - "Pronóstico año 2022"
...
g6_graf_pronosticos(ajuste4, 2020, 90, color = "#02A144")
g6_graf_pronosticos(ajuste4, 2021, 90, color = "#02A144")
g6_graf_pronosticos(ajuste4, 2022, 90, color = "#02A144")
g6_graf_pronosticos(ajuste4, 2023, 90, color = "#02A144")
g6_graf_pronosticos(ajuste4, 2024, 90, color = "#02A144")
```
...
g6_graf_pronosticos(ajuste5, 2020, 90, color = "#E0BF00")
g6_graf_pronosticos(ajuste5, 2021, 90, color = "#E0BF00")
g6_graf_pronosticos(ajuste5, 2022, 90, color = "#E0BF00")
g6_graf_pronosticos(ajuste5, 2023, 90, color = "#E0BF00")
g6_graf_pronosticos(ajuste5, 2024, 90, color = "#E0BF00")
```
